...
for n = 13:13:39 %so chieu
    ...
    for k = 1:5 %k clusting
        path='D:\BACH KHOA\Nam III_Ki I\XLTHS - Ninh Khanh Duy\practice_final\abc\NguyenAmHuanLuyen\';
        files = dir(path);
        ...
        path_kt='D:\BACH KHOA\Nam III_Ki I\XLTHS - Ninh Khanh Duy\practice_final\abc\NguyenAmKiemThu\';
...
% bo sung trung binh
% accuracy_mean1 = zeros(1,3);
% for i = 1:3
%     for j = 1:4
%         accuracy_mean1(1, i) = accuracy_mean1(1, i) + accuracy(i,j);
%     end 
%      accuracy_mean1(1, i) = accuracy_mean1(1, i)/4;
% end
